...
public abstract class IctTestTemplate {
    ...
    protected static void connect(org.iota.ict.Ict ict1, org.iota.ict.Ict ict2) {
        addNeighborToIct(ict1, ict2);
        addNeighborToIct(ict2, ict1);
    }

    private static void addNeighborToIct(org.iota.ict.Ict ict, org.iota.ict.Ict neighbor) {
    ...
    protected static String submitBundle(org.iota.ict.Ict ict, Bundle bundle) {
    ...
    private static class Ict extends org.iota.ict.Ict {

        private Node node;

        Ict(FinalProperties properties) {
            super(properties);
            this.node = super.node;
        }
    }
}
